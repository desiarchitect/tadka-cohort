...
{
    /// <inheritdoc />
    public partial class OrderLifecycleAndDemoSeed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                schema: "restaurant",
                table: "restaurants",
                columns: new[] { "Id", "AvgPrepTimeMinutes", "CreatedAt", "IsActive", "Name", "Address_City", "Address_Latitude", "Address_Line1", "Address_Line2", "Address_Longitude", "Address_Pincode" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                schema: "identity",
                table: "users",
                columns: new[] { "Id", "CreatedAt", "Email", "Name", "Phone", "Role" },
                values: new object[] { new Guid("c1b2c3d4-0001-4000-8000-000000000001"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "priya@tadka.test", "Priya Sharma", "+919876500001", "Customer" });

            migrationBuilder.InsertData(
                schema: "restaurant",
                table: "menu_items",
                columns: new[] { "Id", "Category", "Description", "IsAvailable", "IsVeg", "Name", "RestaurantId", "Price_Amount", "Price_Currency" },
                values: new object[,]
                {
                    { new Guid("b1b2c3d4-0001-4000-8000-000000000001"), "Biryani", "Hyderabadi-style dum biryani with tender chicken", true, false, "Chicken Biryani", new Guid("a1b2c3d4-0001-4000-8000-000000000001"), 299m, "INR" },
                    { new Guid("b1b2c3d4-0002-4000-8000-000000000002"), "Biryani", "Slow-cooked mutton dum biryani with salan", true, false, "Mutton Biryani", new Guid("a1b2c3d4-0001-4000-8000-000000000001"), 399m, "INR" },
                    ...
                    { new Guid("b1b2c3d4-0005-4000-8000-000000000005"), "Starters", "Spicy deep-fried chicken, Hyderabadi classic", true, false, "Chicken 65", new Guid("a1b2c3d4-0001-4000-8000-000000000001"), 229m, "INR" },
                    { new Guid("b1b2c3d4-0006-4000-8000-000000000006"), "Rice", "Comfort food with tempered curd rice", true, true, "Curd Rice", new Guid("a1b2c3d4-0001-4000-8000-000000000001"), 99m, "INR" },
                    { new Guid("b1b2c3d4-0007-4000-8000-000000000007"), "Burgers", "Double-patty smash burger with house sauce", true, false, "Classic Smash Burger", new Guid("a1b2c3d4-0002-4000-8000-000000000002"), 299m, "INR" },
                    { new Guid("b1b2c3d4-0008-4000-8000-000000000008"), "Burgers", "Signature burger with truffle mayo and caramelized onions", true, false, "Truffle Special Burger", new Guid("a1b2c3d4-0002-4000-8000-000000000002"), 449m, "INR" },
                    ...
                    { new Guid("b1b2c3d4-000b-4000-8000-000000000011"), "Sandwiches", "Grilled chicken breast with lettuce and garlic aioli", true, false, "Grilled Chicken Sandwich", new Guid("a1b2c3d4-0002-4000-8000-000000000002"), 279m, "INR" },
