...
ADRs **024, 025, 026**. Diagrams: `docs/diagrams/day-08-*.md`. Options (Java/Node/Go): `docs/learn/day-08-option-space.md`. AI awareness (not a product feature): `docs/learn/ai-engineering.html`.
