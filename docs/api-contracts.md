...
> **OpenAPI 3.1:** [`api/openapi-v1.yaml`](api/openapi-v1.yaml) (paste into [Swagger Editor](https://editor.swagger.io)). **Why each route:** [`api/contract-reasoning.md`](api/contract-reasoning.md). **Path vs query vs body vs header:** [`api/where-data-goes.md`](api/where-data-goes.md). This page is the field-level Markdown companion.
